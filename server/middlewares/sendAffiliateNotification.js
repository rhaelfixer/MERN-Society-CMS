...
// Send Affiliate Notification via Mailchimp
async function sendAffiliateNotification(req, res, next) {
  try {
    ...
    const content = {
      ...
      <p>
        An affiliate article has been created: ${ newAffiliate.title } on ${ newAffiliate.date }.
      </p>
      <p>
...
module.exports = sendAffiliateNotification;
